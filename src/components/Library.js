        ...
        <div>
            <div className='navbar flex h-24 text-xs items-center justify-between px-6 bg-blue-200 text-white'>
                <div className='space-x-4 flex items-center'>
                    ...
                    <button>Schools and Homes</button>
            ...
            <div className='flex-1 flex flex-row text-gray-100'>
                <div className='w-1/4 bg-gray-50 py-4 px-8 space-y-6'>
                    ...
                    <div className='grid grid-cols-2 gap-4 pr-4'>
                        <div className='border-2 rounded-full border-bg-gray-100 text-center p-2'>Lesson</div>
                        <div className='border-2 rounded-full border-bg-gray-100 text-center p-2'>Activities</div>
                        <div className='border-2 rounded-full border-bg-gray-100 text-center p-2'>Videos</div>
                    </div>
                    <div className='text-xl divide-y py-2 border-b-2 border-gray-100'>Subjects</div>
                    <div className='grid grid-cols-2 gap-4 pr-4'>
                        <div className='border-2 rounded-full border-bg-gray-100 text-center p-2'>English</div>
                        <div className='border-2 rounded-full border-bg-gray-100 text-center p-2'>Maths</div>
                        <div className='border-2 rounded-full border-bg-gray-100 text-center p-2'>Science</div>
                    </div>
                </div>
                <div className='w-3/4'>
